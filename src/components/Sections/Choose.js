            ...
            <div className={`${classes.card_one} ${classes.card}`}>
              <div className={classes.card_content}>
                ...
                <div className={classes.card_text_div}>
                  <h5>Easy to order</h5>
                  <p>
                    Order fresh vegetables at a single click and select all grocery items to order at
            ...
            <div className={`${classes.card_two} ${classes.card}`}>
              <div className={classes.card_content}>
                ...
                <div className={classes.card_text_div}>
                  <h5>fast delivery</h5>
                  <p>
                     delivery fast and reliable and get delivered at
            ...
            <div className={`${classes.card_three} ${classes.card}`}>
              <div className={classes.card_content}>
                ...
                <div className={classes.card_text_div}>
                  <h5>100% quality</h5>
                  <p>
                    We provide quality and fresh vegetables for you and your loved ones for
                    health and so on and for wellness
                  </p>
                </div>
              </div>
            </div>
