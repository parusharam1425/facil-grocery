...
A simulation of an Application where you can order and pay for grocerys

# Description

**Details**

GROCERY is an single page application with a well structured layout, where you view both information  of the web app and order vegetable items by adding them to the cart. 
...
Technologies i used to build this are  React.js, Css, react-bootstrap, react-scroll, animation on scroll library
